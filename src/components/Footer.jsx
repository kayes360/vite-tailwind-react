...
export default function Footer() {
    ...
    <div className="xl:grid xl:grid-cols-12 xl:gap-8">
      <div className="grid grid-cols-2 gap-8 md:grid md:grid-cols-2 md:gap-8 lg:grid-cols-3 xl:col-span-7 xl:grid-cols-5">
        ...
        <ul role="list" className="space-y-4">
          ...
          <li>
            <a href="#" className="text-sm font-semibold">EU Finance</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">Capital Market</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">World Economy</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">Opinion</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">Finance</a>
          </li>
        </ul>
        <ul role="list" className="space-y-4">
          <li>
          ...
          <li>
            <a href="#" className="text-sm font-semibold">Agriculture</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">Sport Economy</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">Blog</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">Podcats</a>
          </li>
          <li>
            <a href="#" className="text-sm font-semibold">Video</a>
          </li>
        </ul>
        <ul role="list" className="space-y-4">
          <li>
  ...
  <div className="container mt-6 lg:mt-12">
    <p className="text-center">
      Copyright ©2023 | All rights reserved by Learn with
      Sumit
    </p>
  </div>
</footer>
